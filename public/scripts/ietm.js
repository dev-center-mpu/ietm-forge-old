var ietm = {
    ...
    'item8_1': {
        init: function () {
            console.log('item8_1 loaded')
        },
        content: ` 
        <h2>Мотор-редуктор</h2>
            <p>
                <strong>Мотор-редуктор</strong> - это сложная конструкция, 
                которая представляет собой систему, состоящую из двух элементов: 
                двигателя и, непосредственно, редуктора. Используется мотор-редуктор в тех механизмах, 
                в которых не требуется чрезмерно точное позиционирование. 
                Конструктивно, в мотор-редукторе могут быть использованы червячные, 
                цилиндрические или планетарные редукторы. 
                Так, например, червячный мотор-редуктор предполагает использование, 
                в своей конструкции, червячной передачи. 
                Такой мотор-редуктор обладает относительно бесшумной работой и 
                сравнительно небольшими размерами. 
                <img src = "././img/gbMotor.jpg" width = "90%" style="margin:10px 0px">
            </p>
         `
    },
    'item8_2': {
        init: function () {
            console.log('item8_2 loaded')
        },
        content: ` 
        <h2>Цилиндрический редуктор</h2>
            <p>
                <strong>Цилиндрический редуктор</strong> - такая конструкция редуктора является одной из самых популярных. 
                Цилиндрические редукторы используются для изменения скорости вращения при передаче крутящего момента. 
                Такие редукторы активно применяются в современных узлах и механизмах общепромышленного назначения.
                Цилиндрические редукторы представлены одно-, двух- и трехступенчатыми модификациями. Такие редукторы надежны и долговечны, 
                поэтому, обладающие цилиндрическими редукторами машины и оборудование, выносливы и производительны.
                <img src = "././img/gbCylinder.jpg" width = "90%" style="margin:10px 0px">
            </p>
         `
    },
    'item8_3': {
        init: function () {
            console.log('item8_3 loaded')
        },
        content: ` 
        <h2>Червячный редуктор</h2>
            <p>
                <strong>Червячный редуктор</strong> - конструкция такого редуктора использует передачу, 
                обладающую резьбой с червячным профилем. 
                Механизм червячного редуктора является превосходным решением для передачи 
                крутящего момента между двумя перпендикулярными осями. 
                Так, например, Червячный редуктор используется в рулевом управлении механических транспортных средств, 
                таких, как автомобили. Достоинством червячного редуктора является возможность 
                получения большого передаточного числа в одной ступени (от 80 до нескольких сотен). 
                Червячные редукторы бесшумны, обладают плавностью хода, а также, 
                не требуют использования тормозных механизмов благодаря возможности самостоятельного 
                торможения при достижении определенных передаточных чисел.
                <img src = "././img/gbWorm.jpg" width = "90%" style="margin:10px 0px">
            </p>
         `
    },  
    'item8_4': {
        init: function () {
            console.log('item8_4 loaded')
        },
        content: ` 
        <h2>Комбинированный редуктор</h2>
            <p>
                <strong>Комбинированный редуктор</strong> - совокупность нескольких конструктивных решений, 
                включающая в себя разные виды передач объединенных в одном корпусе. 
                Комбинированный редуктор относится к ряду наиболее практичных редукторов. 
                Он выгодно отличается от других типов редукторов хорошими эксплуатационными характеристиками, 
                при небольших габаритах, а также относительно невысокой ценой. 
                К редукторам комбинированного типа относят: цилиндро-червячные редукторы, коническо-цилиндрические и др.
                <img src = "././img/gbCylinderWorm.jpg" width = "90%" style="margin:10px 0px">
            </p>
         `
    },
    'item8_5': {
        init: function () {
            console.log('item8_5 loaded')
        },
        content: ` 
        <h2>Коническо-цилиндрический редуктор</h2>
            <p>
                <strong>Комбинированный редуктор</strong> - конструктивно 
                включает в себя одну коническую и несколько цилиндрических передач.
                Использование коническо-цилиндрического редуктора оправдано в случаях, 
                когда ось вала подвода перпендикулярно пересекается с осью вала отбора мощности. 
                Коническо-цилиндрический редуктор, в зависимости от специфики эксплуатации, 
                может быть изготовлен в вертикальном или горизонтальном исполнении. 
                В первой ступени конические колеса, как правило, имеют зубья с криволинейным профилем, 
                поскольку именно на эту ступень приходятся максимальные (до 60 тыс. об/мин) линейные и угловые скорости. 
                В подобных случаях, зубья с плавным профилем не могут обеспечить плавность хода. 
                Несомненными преимуществами конструкции коническо-цилиндрического редуктора являются достаточно высокий КПД, 
                износостойкость и долговечность.
                <img src = "././img/gbKonusCylinder.jpg" width = "90%" style="margin:10px 0px">
            </p>
         `
    },
